...
const pairs=[['主要文字 / 暖白面板','text-primary','surface-panel'],['次级文字 / 画布','text-secondary','surface-canvas'],['禁用文字 / 内嵌底色','text-disabled','surface-inset'],['按钮文字 / 主操作','surface-panel','action-primary'],['按钮文字 / 悬停','surface-panel','action-hover'],['按钮文字 / 按下','surface-panel','action-pressed'],['价值损失 / 浅琥珀底','value-warning','value-warning-bg'],['控件边界 / 面板','border-control','surface-panel',3],['焦点轮廓 / 画布','focus-ring','surface-canvas',3]];
